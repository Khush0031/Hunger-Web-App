...
function Footer() {
  return (
    <div className="text-medium mt-6 flex flex-row w-full justify-evenly gap-4 overflow-hidden bg-black p-12 text-gray-400 pb-24 bottom-px">
      {/* item1 */}
      <div className="flex flex-col gap-2 xs:gap-1 whitespace-nowrap sm:overflow-hidden">
        <h3 className="text-2xl xs:text-lg font-bold flex items-center gap-2 xs:gap-1 text-white">
          ...
          <span className="hover:text-orange-400 cursor-pointer">Hunger</span>
        </h3>
        <span className=""> &copy; 2024 Khush </span>
      </div>
      ...
      <div className="flex flex-col gap-2 xs:gap-1  whitespace-nowrap sm:overflow-hidden">
        ...
        <span>Careers</span>
        <span>Team</span>
        <span>Hunger One</span>
        <span>Hunger Instamart</span>
        <span>Hunger Genie</span>
      </div>
